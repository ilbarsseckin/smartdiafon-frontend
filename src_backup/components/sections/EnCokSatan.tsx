...
export default function EnCokSatan() {
  ...
  useEffect(() => {
    api.get('/api/catalog/products/best-sellers?limit=8')
      .then(r => setProducts(r.data.data || []))
      .catch(() => setProducts([]))
      .finally(() => setLoading(false))
  }, [])

  // Hiç sipariş yoksa veya endpoint daha yoksa bölümü gizle
    ...
    <section className="py-10 md:py-16">
      <div className="max-w-7xl mx-auto px-6">
        <SectionHeader
          ...
          badgeIcon="trending"
          title=""
          subtitle="En çok sipariş verilen ürünler"
          seeAllHref="/urunler?sort=popular"
        />
