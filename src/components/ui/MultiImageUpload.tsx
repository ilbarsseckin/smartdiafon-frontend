      ...
      <div className="grid grid-cols-4 gap-2">
        ...
        {canAddMore && (
          <button onClick={() => inputRef.current?.click()} disabled={uploading}
            className="aspect-square rounded-lg border-2 border-dashed border-black/[0.1] dark:border-white/[0.1] hover:border-[#E63946] flex flex-col items-center justify-center gap-1 transition-colors disabled:opacity-50"
            type="button">
            {uploading ? (
