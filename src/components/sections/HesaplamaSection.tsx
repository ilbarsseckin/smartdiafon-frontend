    ...
    <section className="py-20" style={{ background: 'var(--bg-secondary)' }}>
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-3 mb-10">
          <div>
            <p className="text-[11px] tracking-[2.5px] uppercase font-bold text-[#E63946] mb-3">Fiyat Hesaplama</p>
          ...
          <div className="flex items-center gap-2 px-4 py-2 rounded-xl"
            ...
            <span className="text-[14px] font-bold text-[#E63946]">{kur.toFixed(2)} ₺</span>
          </div>
        </div>
        ...
        <div className="rounded-2xl p-8" style={{ background: 'var(--bg-card)', border: '1px solid var(--border)' }}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-6">
            ...
            <div className="flex items-end">
              <div className="px-4 py-3 rounded-xl w-full"
                ...
                <p className="text-[16px] font-bold text-[#E63946] mt-0.5">
          ...
          <div className="flex items-center gap-6 flex-wrap">
            <button onClick={hesapla} disabled={calcLoading || !selectedSlug}
              className="flex items-center gap-2 bg-[#E63946] text-white text-[14px] font-bold px-10 py-4 rounded-xl hover:bg-[#C1272D] transition-colors shadow-sm disabled:opacity-50">
            ...
            {sonuc && (
              <div className="flex-1 grid grid-cols-1 sm:grid-cols-3 gap-4">
                ...
                <div className="px-5 py-4 rounded-xl border-2 border-[#E63946]/40"
                  style={{ background: 'rgba(230,57,70,0.06)' }}>
                  <p className="text-[10px] uppercase tracking-[1px] font-bold text-[#E63946]">Toplam (₺)</p>
                  <p className="text-[28px] font-bold mt-1 text-[#E63946]" style={{ fontFamily: 'Georgia, serif' }}>
