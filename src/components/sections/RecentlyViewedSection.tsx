    ...
    <Link href={`/urun/${product.slug}`}
      ...
      <div className="rounded-xl overflow-hidden transition-all hover:shadow-md hover:-translate-y-0.5"
        ...
        <div className="p-2.5">
          ...
          <p className="text-[12px] font-bold leading-tight line-clamp-2 group-hover:text-[#DC2626] transition-colors"
            style={{ color: 'var(--text-primary)' }}>
            {product.name}
          </p>
          {minPrice != null && Number(minPrice) > 0 && (
            <p className="text-[11px] font-black mt-1.5 text-[#DC2626]">
