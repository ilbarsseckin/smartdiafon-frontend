...
export default function KampanyaSection() {
  return (
    <section className="px-4 md:px-6 py-10 md:py-12 max-w-7xl mx-auto">
      <div className="relative overflow-hidden rounded-3xl md:rounded-[32px] bg-gradient-to-r from-[#111111] via-[#1f1f1f] to-[#E63946] p-6 sm:p-8 md:p-12">
        <div className="absolute -right-16 -top-16 h-56 w-56 rounded-full bg-white/10 blur-2xl" />
        <div className="absolute right-20 bottom-0 h-32 w-32 rounded-full bg-[#E63946]/40 blur-xl" />
        ...
        <div className="relative z-10 max-w-2xl">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <Link
              href="/urunler"
              className="inline-flex justify-center rounded-full bg-[#E63946] px-6 sm:px-7 py-3 text-[13px] sm:text-sm font-bold text-white hover:bg-[#e87512] transition"
            >
