    ...
    <Link
      ...
      <div className="rounded-2xl overflow-hidden transition-all duration-300 hover:-translate-y-1 hover:shadow-lg h-full"
        ...
        <div className="relative aspect-square overflow-hidden" style={{ background: 'var(--bg-secondary)' }}>
          ...
          <span className="absolute left-2 top-2 z-10 rounded-full bg-[#E63946] px-2 py-0.5 text-[8px] font-black uppercase tracking-[1px] text-white">
            Yeni
          </span>
          {hasPrice && (
            <div className="absolute bottom-2 right-2 z-10 rounded-full bg-white px-2.5 py-1 shadow-md dark:bg-gray-900">
              <span className="text-[11px] font-black text-[#E63946]">${price.toFixed(2)}</span>
            </div>
          )}
        </div>
        ...
        <div className="p-3">
          ...
          <h3 className="line-clamp-2 text-[12px] sm:text-[13px] font-bold leading-tight group-hover:text-[#E63946] transition-colors"
