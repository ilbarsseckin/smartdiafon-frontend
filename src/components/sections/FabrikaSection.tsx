    ...
    <section id="fabrika" className="py-20" style={{ background: 'var(--bg-secondary)' }}>
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex items-end justify-between mb-12">
          <div>
            <p className="text-[11px] tracking-[2.5px] uppercase font-bold text-[#E63946] mb-3">Fabrika</p>
          ...
          <span className="text-[12px] font-semibold text-[#E63946] cursor-pointer hover:underline">
            Galeriyi gör →
          </span>
        </div>
