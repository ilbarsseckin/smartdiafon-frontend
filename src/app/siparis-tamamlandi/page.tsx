        ...
        <main className="min-h-screen flex items-center justify-center py-12" style={{ background: 'var(--bg-secondary)' }}>
          <div className="text-center max-w-sm mx-auto px-6">
            ...
            <p className="text-[13px] mb-6" style={{ color: 'var(--text-muted)' }}>
              Sipariş no: <code className="font-mono font-bold" style={{ color: '#E63946' }}>
                {order.orderNumber}
              </code>
            </p>
          ...
          {order && (
            <div className="bg-white dark:bg-[#141414] border border-black/[0.07] dark:border-white/[0.07] rounded-xl p-4 mb-5">
              <div className="flex justify-between items-center mb-3">
                ...
                <p className="text-[22px] font-medium text-[#E63946]">
          ...
          <div className="bg-white dark:bg-[#141414] border border-black/[0.07] dark:border-white/[0.07] rounded-2xl p-6 space-y-4">
            ...
            <div>
              ...
              <input type="text" placeholder="AD SOYAD"
                ...
                className="w-full px-3.5 py-2.5 text-[13px] border border-black/[0.08] dark:border-white/[0.08] rounded-lg bg-white dark:bg-[#1a1a1a] text-gray-900 dark:text-gray-100 outline-none focus:border-[#E63946] transition-colors" />
            ...
            <div>
              ...
              <input type="text" inputMode="numeric" placeholder="0000 0000 0000 0000"
                ...
                className="w-full px-3.5 py-2.5 text-[13px] border border-black/[0.08] dark:border-white/[0.08] rounded-lg bg-white dark:bg-[#1a1a1a] text-gray-900 dark:text-gray-100 outline-none focus:border-[#E63946] transition-colors tracking-widest font-mono" />
            ...
            <div className="grid grid-cols-3 gap-3">
              <div>
                ...
                <input type="text" inputMode="numeric" placeholder="MM" maxLength={2}
                  ...
                  className="w-full px-3.5 py-2.5 text-[13px] border border-black/[0.08] dark:border-white/[0.08] rounded-lg bg-white dark:bg-[#1a1a1a] text-gray-900 dark:text-gray-100 outline-none focus:border-[#E63946] transition-colors text-center" />
            ...
            <button onClick={handleSubmit} disabled={paymentLoading}
              className="w-full bg-[#E63946] text-white text-[14px] font-medium py-3.5 rounded-xl hover:opacity-90 transition-opacity disabled:opacity-50 flex items-center justify-center gap-2">
              {paymentLoading
