              ...
              <form onSubmit={handleSubmit(handleStep1)} className="space-y-5">
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-3.5 py-2.5 text-[13px] border border-black/[0.08] dark:border-white/[0.08] rounded-lg bg-white dark:bg-[#1a1a1a] text-gray-900 dark:text-gray-100 outline-none focus:border-[#E63946]"
                  >
                ...
                {price && (
                  <div className="bg-orange-50 dark:bg-orange-500/10 border border-orange-100 dark:border-orange-500/20 rounded-xl p-4">
                    ...
                    <div className="text-[22px] font-medium text-[#E63946] tracking-[-0.4px]">
                ...
                <button
                  type="submit"
                  disabled={submitting}
                  className="w-full bg-[#E63946] text-white text-[14px] font-medium py-3 rounded-lg hover:opacity-90 transition-opacity disabled:opacity-50"
                >
            ...
            {step === 1 && (
              <div className="space-y-5">
                <div>
                  ...
                  <label className="block border-2 border-dashed border-black/[0.1] dark:border-white/[0.1] rounded-xl p-8 text-center cursor-pointer hover:border-[#E63946] transition-colors">
                ...
                <div className="flex gap-3">
                  ...
                  <button
                    ...
                    className="flex-1 bg-[#E63946] text-white text-[13px] font-medium py-2.5 rounded-lg hover:opacity-90 transition-opacity disabled:opacity-50"
                  >
              ...
              <div className="space-y-4">
                ...
                <div className="flex gap-3">
                  ...
                  <button
                    ...
                    className="flex-1 bg-[#E63946] text-white text-[13px] font-medium py-2.5 rounded-lg hover:opacity-90 transition-opacity"
                  >
                    Sepete git →
                  </button>
                </div>
