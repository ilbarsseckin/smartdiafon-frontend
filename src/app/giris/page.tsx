    ...
    <div className="min-h-screen bg-gray-50 dark:bg-[#0a0a0a] flex items-center justify-center p-4">
      <div className="w-full max-w-[400px]">
        <div className="text-center mb-8">
          <Link href="/" className="inline-flex items-center gap-2 mb-6">
            <div className="w-9 h-9 rounded-xl bg-gray-900 dark:bg-gray-100 flex items-center justify-center">
              <Printer size={18} className="text-[#E63946]" />
            </div>
            <Logo className="h-7" />
          </Link>
        ...
        <div className="bg-white dark:bg-[#141414] border border-black/[0.08] dark:border-white/[0.08] rounded-2xl p-6">
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                <input type={showPass ? 'text' : 'password'} placeholder="••••••••"
                  ...
                  className="w-full px-3.5 py-2.5 pr-10 text-[13px] border border-black/[0.08] dark:border-white/[0.08] rounded-lg bg-white dark:bg-[#1a1a1a] text-gray-900 dark:text-gray-100 outline-none focus:border-[#E63946] transition-colors" />
            ...
            <button type="submit" disabled={isSubmitting}
              className="w-full bg-[#E63946] text-white text-[14px] font-medium py-3 rounded-lg hover:opacity-90 transition-opacity disabled:opacity-50 mt-2">
        ...
        <p className="text-center text-[12px] text-gray-400 mt-4">
          Hesabınız yok mu?{' '}
          <Link href="/kayit" className="text-[#E63946] hover:underline">Kayıt olun</Link>
        </p>
      </div>
    </div>
  )
