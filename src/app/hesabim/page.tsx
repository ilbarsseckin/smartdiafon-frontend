        ...
        <div className="max-w-5xl mx-auto px-6 py-12">
          ...
          <div className="flex border-b mb-6" style={{ borderColor: 'var(--border)' }}>
            <button onClick={() => setActiveTab('catalog_orders')}
              ...
              style={{
                color: activeTab === 'catalog_orders' ? '#DC2626' : 'var(--text-muted)',
                borderBottom: activeTab === 'catalog_orders' ? '2px solid #DC2626' : '2px solid transparent',
              }}>
              <Truck size={14} /> Siparişlerim
              {catalogOrders.length > 0 && (
                <span className="text-[10px] px-1.5 py-0.5 rounded-full"
                  style={{
                    background: activeTab === 'catalog_orders' ? '#DC2626' : 'var(--border)',
            ...
            <button onClick={() => setActiveTab('addresses')}
              className="flex items-center gap-2 px-5 py-3 text-[13px] font-bold transition-colors -mb-px"
              style={{
                color: activeTab === 'addresses' ? '#DC2626' : 'var(--text-muted)',
                borderBottom: activeTab === 'addresses' ? '2px solid #DC2626' : '2px solid transparent',
              }}>
              <MapPin size={14} /> Adreslerim
              {addresses.length > 0 && (
                <span className="text-[10px] px-1.5 py-0.5 rounded-full"
                  style={{
                    background: activeTab === 'addresses' ? '#DC2626' : 'var(--border)',
            ...
            <>
              ...
              {catalogOrdersLoading ? (
                ...
                <div className="rounded-xl p-10 text-center"
                  ...
                  <Link href="/urunler" className="inline-block mt-3 text-[12px] font-bold text-[#DC2626] hover:underline">
                    Ürünlere göz at →
                  </Link>
                </div>
              ) : (
                      ...
                      <div key={o.id}
                        ...
                        <div className="flex items-start justify-between gap-3">
                          ...
                          <div className="text-right flex-shrink-0">
                            <p className="text-[18px] font-black" style={{ color: '#DC2626' }}>
            ...
            <>
              {ordersLoading ? (
                ...
                <div className="bg-white dark:bg-[#141414] border border-black/[0.07] dark:border-white/[0.07] rounded-xl p-10 text-center">
                  ...
                  <Link href="/" className="inline-block mt-3 text-[12px] text-[#DC2626] hover:underline">
                    İlk siparişini ver →
                  </Link>
                </div>
              ) : (
                  ...
                  {orders.map((o: any) => {
                    ...
                    return (
                      <Link key={o.id} href={`/hesabim/siparisler/${o.id}`}
                        className="block bg-white dark:bg-[#141414] border border-black/[0.07] dark:border-white/[0.07] rounded-xl p-4 hover:border-[#DC2626] transition-colors">
            ...
            <>
              <div className="flex items-center justify-between mb-4">
                ...
                <button onClick={openAddModal}
                  className="flex items-center gap-1.5 px-4 py-2 text-[12px] font-bold text-white rounded-lg bg-[#DC2626] hover:bg-[#b91c1c] transition-colors">
              ...
              {addressesLoading ? (
                ...
                <div className="bg-white dark:bg-[#141414] border border-black/[0.07] dark:border-white/[0.07] rounded-xl p-10 text-center">
                  ...
                  <button onClick={openAddModal}
                    className="inline-flex items-center gap-1.5 px-5 py-2.5 text-[12px] font-bold text-white rounded-lg bg-[#DC2626] hover:bg-[#b91c1c] transition-colors">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  {addresses.map(a => (
                    <div key={a.id}
                      ...
                      style={{ border: a.isDefault ? '1.5px solid #DC2626' : '1px solid var(--border)' }}>
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          {a.isDefault && (
                            <span className="text-[9px] px-1.5 py-0.5 rounded font-bold flex items-center gap-0.5"
                              style={{ background: 'rgba(244,130,31,0.15)', color: '#DC2626' }}>
                ...
                <div className="rounded-lg p-3"
                  ...
                  <label className="flex items-center gap-2 cursor-pointer">
                    ...
                    <span className="text-[12px] font-bold flex items-center gap-1">
                      <Star size={11} className="text-[#DC2626]" />
