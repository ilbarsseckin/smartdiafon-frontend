      ...
      <main>
        ...
        <div style={{ background: 'var(--bg-secondary)', borderBottom: '1px solid var(--border)' }}>
          <div className="max-w-4xl mx-auto px-6 py-16 md:py-24">
            ...
            <h1 className="text-[36px] md:text-[52px] font-black tracking-[-2px] leading-[1.1] mb-6"
              ...
              <span className="text-[#F4821F]">Yeni Nesil Matbaa</span> ��z�mleri
            </h1>
        ...
        <div className="max-w-4xl mx-auto px-6 py-16">
          ...
          <p className="text-[14px] leading-[1.8] mb-4" style={{ color: 'var(--text-secondary)' }}>
            Kesinlikle! bask�urunleri.com, sadece profesyonel tasar�mc�lar i�in de�il, herkese hitap eder. Web sitemizde yer alan <strong style={{ color: '#F4821F' }}>�cretsiz online tasar�m ara�lar�</strong> sayesinde, binlerce haz�r �ablon aras�ndan sekt�r�n�ze uygun alan� se�ebilir; logo, metin ve g�rsellerinizi d�zenleyebilirsiniz. Ayr�ca dilerseniz, uzman grafik ekibimizden profesyonel tasar�m deste�i talep edebilirsiniz.
          </p>
        </div>
