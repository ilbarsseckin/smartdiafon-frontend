      ...
      <div className="rounded-xl p-4"
        ...
        <div className="grid grid-cols-2 gap-2 mb-2">
          <button type="button" onClick={() => setMode('url')}
            ...
            style={mode === 'url'
              ? { background: 'rgba(244,130,31,0.1)', color: '#DC2626', border: '1.5px solid #DC2626' }
        ...
        <div className="max-w-7xl mx-auto px-6 py-8">
          ...
          <div className="flex items-start justify-between mb-6 flex-wrap gap-3">
            ...
            <button onClick={openCreate}
              className="flex items-center gap-1.5 px-4 py-2 text-[12px] font-bold rounded-lg bg-[#DC2626] text-white hover:bg-[#b91c1c] transition-colors">
                ...
                <div key={s.id} className="rounded-xl overflow-hidden flex items-stretch gap-0"
                  ...
                  <div className="flex-1 p-4 min-w-0">
                    <div className="flex items-center gap-2 mb-1 flex-wrap">
                      {s.label && (
                        <span className="text-[10px] font-black px-1.5 py-0.5 rounded text-white bg-[#DC2626]">
                          {s.label}
                        </span>
                      )}
          ...
          <div className="w-full max-w-2xl max-h-[90vh] rounded-2xl overflow-hidden flex flex-col"
                ...
                <div className="flex gap-2 flex-wrap items-center">
                  {PRESET_COLORS.map(c => (
                    <button key={c} type="button"
                      ...
                      style={{
                        background: c,
                        border: form.backgroundColor === c ? '2px solid #DC2626' : '2px solid var(--border)',
                      }} />
                  ))}
            ...
            <div className="flex items-center justify-end gap-2 px-5 py-3"
              ...
              <button onClick={handleSave} disabled={saving}
                className="flex items-center gap-1.5 px-4 py-2 text-[12px] font-bold text-white rounded-lg bg-[#DC2626] hover:bg-[#b91c1c] transition-colors disabled:opacity-50">
