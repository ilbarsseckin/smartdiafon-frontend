...
const PRESET_COLORS = ['#E63946', '#111111', '#1D4ED8', '#16A34A', '#E63946', '#7C3AED', '#0891B2', '#DB2777']
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8">
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-2">
            <Megaphone size={20} style={{ color: '#E63946' }} />
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div className="flex gap-1">
                      {['#FFFFFF', '#111111', '#E63946'].map(c => (
                        <button key={c} onClick={() => setForm(f => ({ ...f, textColor: c }))}
                          className="w-5 h-5 rounded"
                          style={{ background: c, border: form.textColor === c ? '2px solid #E63946' : '1px solid var(--border)' }} />
                      ))}
                    </div>
                  </div>
                </div>
