          ...
          <div className="flex items-center justify-between mb-4 sm:mb-6">
            <div>
              <div className="flex items-center gap-2 mb-0.5">
                ...
                <h1 className={`text-[18px] sm:text-[22px] font-bold tracking-[-0.5px] transition-colors ${newOrderFlash ? 'text-[#DC2626]' : ''}`}
                  style={{ color: newOrderFlash ? '#DC2626' : 'var(--text-primary)' }}>
                  Katalog Siparişleri
                </h1>
                {newOrderFlash && (
            ...
            <div className="flex items-center gap-2">
              ...
              <button onClick={toggleSound}
                ...
                style={{
                  ...
                  color: soundEnabled ? '#DC2626' : 'var(--text-muted)',
                }}>
          ...
          <div className="flex gap-2 mb-4">
            ...
            <div className="relative sm:hidden">
              <button onClick={() => setFilterOpen(o => !o)}
                ...
                style={{ background: filter ? '#DC2626' : 'var(--bg-card)', color: filter ? 'white' : 'var(--text-secondary)', border: '1px solid var(--border)' }}>
                {activeFilterLabel}
              ...
              {filterOpen && (
                <div className="absolute right-0 top-full mt-1 w-44 rounded-xl shadow-xl z-20 overflow-hidden"
                  ...
                  <button onClick={() => { setFilter(''); setFilterOpen(false) }}
                    ...
                    style={{ color: !filter ? '#DC2626' : 'var(--text-secondary)', background: !filter ? 'rgba(244,130,31,0.08)' : 'transparent' }}>
                    Tümü
                  </button>
                    ...
                    <div className="flex items-start justify-between gap-3">
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-1.5 mb-1 flex-wrap">
                          <code className="text-[12px] sm:text-[13px] font-mono font-bold" style={{ color: '#DC2626' }}>
                            {o.orderNumber}
                          </code>
                      ...
                      <div className="text-right flex-shrink-0">
                        <p className="text-[18px] sm:text-[20px] font-black tracking-[-0.5px]" style={{ color: '#DC2626' }}>
