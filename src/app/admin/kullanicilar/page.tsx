        ...
        <div className="max-w-5xl mx-auto px-6 py-10">
          ...
          <div className="relative mb-4 max-w-[320px]">
            ...
            <input type="text" placeholder="İsim veya e-posta ara..." value={search}
              ...
              className="w-full pl-9 pr-3 py-2 text-[13px] border border-black/[0.08] dark:border-white/[0.08] rounded-lg bg-white dark:bg-[#141414] text-gray-900 dark:text-gray-100 outline-none focus:border-[#DC2626]" />
          </div>
                          ...
                          <div className="flex flex-wrap gap-2">
                            {uRoles.map(r => (
                              <div key={r.id} className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg bg-white dark:bg-[#141414] border border-black/[0.07] dark:border-white/[0.07]">
                                <Shield size={11} className="text-[#DC2626]" />
                      ...
                      <div>
                        ...
                        <div className="flex gap-2">
                          <select value={selectedRole[u.id] || ''}
                            ...
                            className="flex-1 px-3 py-2 text-[13px] border border-black/[0.08] dark:border-white/[0.08] rounded-lg bg-white dark:bg-[#1a1a1a] text-gray-900 dark:text-gray-100 outline-none focus:border-[#DC2626]">
                          ...
                          <button onClick={() => assignRole(u.id)}
                            ...
                            className="bg-[#DC2626] text-white text-[12px] font-medium px-4 py-2 rounded-lg hover:opacity-90 transition-opacity disabled:opacity-50">
