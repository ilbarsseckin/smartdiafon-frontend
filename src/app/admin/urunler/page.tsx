                              ...
                              <div className="relative">
                                {p.featured && (
                                  <span className="absolute -top-1 -left-1 z-10">
                                    <Star size={12} className="text-[#DC2626] fill-[#DC2626]" />
                                  </span>
                                )}
                                {p.imageUrl
            ...
            <div className="max-w-2xl">
              <div className="rounded-2xl p-6 space-y-5"
                ...
                <div className="flex items-center justify-between">
                  ...
                  {editId && (
                    <button onClick={resetForm} className="text-[11px] text-[#DC2626] hover:underline">
                      Yeni ürüne geç
                    </button>
                  )}
                </div>
                    ...
                    <div className="flex gap-2 flex-wrap">
                      {KATEGORILER.map(k => (
                        <button key={k.slug} type="button" onClick={() => setKategori(k.slug)}
                          ...
                          style={{
                            background: form.kategoriSlug === k.slug ? '#DC2626' : 'var(--bg-secondary)',
                            color: form.kategoriSlug === k.slug ? 'white' : 'var(--text-secondary)',
                            borderColor: form.kategoriSlug === k.slug ? '#DC2626' : 'var(--border)',
                    ...
                    <div className="col-span-2">
                      ...
                      <div className="space-y-2">
                        ...
                        <button type="button"
                          ...
                          style={{ color: '#DC2626', border: '1px dashed var(--border)' }}>
                          + Barem ekle
                        </button>
                      </div>
            ...
            <div className="max-w-2xl space-y-4">
              <div className="rounded-2xl p-6"
                ...
                <label className={`block border-2 border-dashed rounded-xl p-10 text-center cursor-pointer transition-colors ${
                  importing ? 'border-[#DC2626]' : 'hover:border-[#DC2626]'}`}
                  style={{ borderColor: importing ? '#DC2626' : 'var(--border-strong)' }}>
                  {importing
                    ? <Loader2 size={28} className="mx-auto mb-3 animate-spin text-[#DC2626]" />
            ...
            <div className="max-w-lg">
              <div className="rounded-2xl p-6 space-y-5"
                ...
                <div className="p-3 rounded-xl text-[12px]"
                  style={{ background: 'rgba(244,130,31,0.06)', border: '1px solid rgba(244,130,31,0.2)', color: '#DC2626' }}>
