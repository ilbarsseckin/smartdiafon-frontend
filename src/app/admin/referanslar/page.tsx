...
const COLORS = ['#E31E24','#003087','#E8000D','#F40009','#D62300','#006491','#F26522','#012169','#8A1538','#1B4F72','#E63946','#1D9E75','#534AB7']

const emptyForm = { name: '', sector: '', category: CATEGORIES[0], description: '', color: '#E63946', abbr: '', featured: false, active: true, showText: true, displayOrder: 0, logoUrl: '' }
...
const openEdit = (ref: any) => {
    ...
    setForm({
      ...
      description: ref.description || '', color: ref.color || '#E63946',
          ...
          <div className="flex items-center justify-between mb-8">
            ...
            <div className="flex gap-2">
              ...
              <button onClick={openNew}
                className="flex items-center gap-2 bg-[#E63946] text-white text-[13px] font-bold px-5 py-2.5 rounded-xl hover:bg-[#C1272D] transition-colors">
          ...
          <div className="flex gap-2 mb-6 flex-wrap">
            {['Tümü', ...CATEGORIES].map(cat => (
              <button key={cat} onClick={() => setFilterCat(cat)}
                ...
                style={filterCat === cat
                  ? { background: '#E63946', color: 'white', border: '1px solid #E63946' }
                  ...
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-1.5">
                        ...
                        {ref.featured && <Star size={11} className="text-[#E63946] flex-shrink-0" fill="#E63946" />}
                      </div>
                      <span className="text-[11px] text-[#E63946] font-semibold">{ref.sector}</span>
                    </div>
                  </div>
          ...
          <div className="w-full max-w-3xl rounded-2xl p-6 max-h-[90vh] flex flex-col"
            ...
            {bulkSaving && (
              <div className="mb-4 rounded-full overflow-hidden h-2" style={{ background: 'var(--bg-secondary)' }}>
                <div className="h-full bg-[#E63946] transition-all duration-300" style={{ width: `${bulkProgress}%` }} />
              </div>
            )}
