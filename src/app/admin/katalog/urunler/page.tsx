      ...
      <main className="min-h-screen" style={{ background: 'var(--bg-secondary)' }}>
        <div className="max-w-7xl mx-auto px-6 py-8">
          ...
          <div className="flex items-center justify-between mb-6 flex-wrap gap-3">
            <div>
              <div className="flex items-center gap-2 mb-1">
                <Package size={18} className="text-[#E63946]" />
          ...
          {loading ? (
            ...
            <div className="text-center py-16 rounded-2xl"
              ...
              <p className="text-[12px] mb-4 max-w-md mx-auto" style={{ color: 'var(--text-muted)' }}>
                Önce <Link href="/admin/katalog/kategoriler" className="text-[#E63946] hover:underline">kategoriler</Link> ve
                istersen <Link href="/admin/katalog/markalar" className="text-[#E63946] hover:underline">markalar</Link> tanımla,
                sonra ürün eklemeye başla.
              </p>
              <Link href="/admin/katalog/urunler/new"
                className="inline-flex items-center gap-1.5 text-[12px] font-bold text-[#E63946] hover:underline">
            ...
            <div className="text-center py-12 text-[13px]" style={{ color: 'var(--text-muted)' }}>
              ...
              <button onClick={clearFilters} className="ml-2 text-[#E63946] hover:underline">
                Filtreleri temizle
              </button>
            </div>
          ) : (
                  ...
                  <div key={p.id} className="rounded-2xl overflow-hidden transition-all hover:shadow-md group"
                    ...
                    <div className="aspect-[4/3] relative overflow-hidden"
                      ...
                      <div className="absolute top-2 left-2 z-10 flex flex-col gap-1">
                        {p.featured && (
                          <span className="w-7 h-7 rounded-full bg-[#E63946] flex items-center justify-center shadow-md"
                            title="Öne çıkan">
          ...
          <div className="mt-6 p-4 rounded-xl text-[12px]"
            style={{ background: 'rgba(230,57,70,0.05)', border: '1px solid rgba(230,57,70,0.2)', color: 'var(--text-secondary)' }}>
